<script>
  ...
  function handleClick() {
    dispatch("buyPermit", { permitId: permitId }); 
  }
...
>
  ...
  <div class="detailsWrapper flex fdc jcse">
    <div class="flex jcsb">
      <div>
    ...
    {#if !isExpanded}
      <div class="flex aic jcsb">
        <p style="font-size: .85rem;">Know More</p>
  ...
  <div class="btnContainer flex jcc clickable">
    <button
      type="button"
      on:click={handleClick}
      style={!isExpanded
        ? "background-color: #0f3cc9;color: white"
        : "background-color: white;color: black"}>Get Now</button
    >
  </div>
</div>
